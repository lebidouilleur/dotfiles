### lambda.theme.bash ---                            -*- mode: shell-script; -*-
...
function command_prompt {
    PS1="$TEXT_FORMAT_FOREGROUND_LIGHT_RED\w "
    if sh.scm.is_repository
    then
        PS1+="$TEXT_FORMAT_FOREGROUND_LIGHT_GREEN$(sh.scm.branch_name)"
    fi
    PS1+="$TEXT_FORMAT_RESET λ "
}
